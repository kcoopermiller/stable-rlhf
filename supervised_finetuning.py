...
"""
Fine-Tune StableLM-7b on SE paired dataset
"""


def get_args():
    parser = argparse.ArgumentParser()
    parser.add_argument("--model_path", type=str, default="StabilityAI/stablelm-base-alpha-3b")
...
def run_training(args, train_data, val_data):
    ...
    training_args = TrainingArguments(
        ...
        run_name="stablelm-3b-finetuned",
        report_to="wandb",
...
def main(args):
    ...
    tokenizer = AutoTokenizer.from_pretrained(args.model_path, use_auth_token=access_token)
...
if __name__ == "__main__":
    args = get_args()
    assert args.model_path != "", "Please provide the stable model path"
